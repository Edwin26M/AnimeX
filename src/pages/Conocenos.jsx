...
export default function Conocenos () {
    return (
        <>
            <div className="flex flex-col lg:flex-row items-center mt-10 lg:mt-20 lg:mb-20 bg-gradient-to-b from-black via-gray-900 to-blue-950 min-h-screen p-6">
                <div className="flex-1 lg:pr-16 lg:pl-8 text-center lg:text-left mb-8 lg:mb-0">
                    <p className="text-white text-lg sm:text-xl mb-4">Tu lugar favorito para descubrir y disfrutar anime en alta calidad.
                    </p>
                    <br/>
